...
export default {
  ...
  data(){
    return {
      state:{
        baseURL: 'http://games1.whitehot.ninja/b',
        baseDemoURL: 'http://games1.whitehot.ninja',
        baseVideoURL: 'http://whitehot.ninja',
        baseDomain: 'games1.whitehot.ninja',
        baseUserDomain: 'games1.whitehot.ninja',
        rootDomain: 'games1.whitehot.ninja',
  ...
  methods:{
      ...
      if(vars.length>0){
        switch(vars[0]){
          case 'post':
            ...
            break
          case 'u':
            if(!vars[1]) window.location.href = window.location.origin + '/b/'
            ...
            if(vars[2]){
              ...
              if(vars[3]){
                ...
                search = '/' + vars[3]
                history.pushState(null,null,window.location.origin + '/b/?i=/u/' + (this.state.user.name) + '/' + (this.state.curPage + 1)) + search
                this.beginSearch()
              }else{
                if(!this.state.curUserPage || this.state.curUserPage < 0 || this.state.curUserPage > 1e6) this.state.curUserPage = 0
                history.pushState(null,null,window.location.origin + '/b/?i=/u/' + (vars[1]) + ((this.state.curUserPage) ? '/' + (this.state.curUserPage + 1) : ''))
                this.getPages()
              }
            } else {
          ...
          default:
            ...
            if(vars[0]){
              ...
              if(vars[1]){
                ...
                search = '/' + vars[1]
                history.pushState(null,null,window.location.origin + '/b/?i=/' + (this.state.curPage + 1)) + search
                this.beginSearch()
              }else{
                this.state.mode = 'default'
                history.pushState(null,null,window.location.origin+"/b/" + this.state.curPage ? ('?i=' + (this.state.curPage + 1)) : '')
        ...
        this.state.mode = 'default'
        this.getPages()
        if(window.location.href !== window.location.origin+"/b/") window.location.href = window.location.origin+"/b/"
      }
    },
    getPages(){
      switch(this.state.mode){
    ...
    firstPage(){
      ...
      switch(this.state.mode){
        case 'u':
          window.location.href = window.location.origin + '/b/?i=/u/' + this.state.user.name + search
        break
        case 'default':
          window.location.href = window.location.origin + search
        break
        case 'post':
          window.location.href = window.location.origin + '/b/?i=/post/' + this.state.curPost + search
        break
      }
    },
    jumpToPage(pageNo){
      ...
      switch(this.state.mode){
        case 'u':
        window.location.href = window.location.origin + '/b/?i=/u/' + this.user.name + '/' + pageNo + search
        break
        case 'default':
        window.location.href = window.location.origin + '/b/?i=/' + pageNo + search
        break
        case 'post':
        window.location.href = window.location.origin + '/b/?i=/post/' + this.decToAlpha(this.state.curPost) + '/' + pageNo + search
        break
      }
    },
    lastPage(){
      ...
      switch(this.state.mode){
        case 'u':
          window.location.href = window.location.origin + '/b/?i=/u/' + this.state.user.name + '/' + this.state.totalUserPages + search
        break
        case 'default':
          window.location.href = window.location.origin + '/b/' + this.state.totalPages + search
        break
        case 'post':
          window.location.href = window.location.origin + '/b/?i=/post/' + this.decToAlpha(this.state.curPost) + '/' + this.state.totalPages + search
        break
      }
    },
    advancePage(){
      ...
      switch(this.state.mode){
        case 'u':
          window.location.href = window.location.origin + '/b/?i=/u/' + this.state.user.name + '/' + (this.state.curUserPage + 2) + search
        break
        case 'default':
          window.location.href = window.location.origin + '/b/?i=/' + (this.state.curPage + 2) + search
        break
        case 'post':
          window.location.href = window.location.origin + '/b/?i=/post/' + this.decToAlpha(this.state.curPost) + '/' +(this.state.curPage + 2) + search
        break
      }
    },
    regressPage(){
      let search = this.state.search.string ? ('/?i=/' + (this.state.search.string)) : ''
      switch(this.state.mode){
        case 'u':
          window.location.href = window.location.origin + '/b/?i=/u/' + this.state.user.name + '/' + this.state.curUserPage + search
        break
        case 'default':
          window.location.href = window.location.origin + '/b/?i=/' + this.state.curPage + search
        break
        case 'post':
          window.location.href = window.location.origin + '/b/?i=/post/' + this.decToAlpha(this.state.curPost) + '/' +(this.state.curPage + 2) + search
        break
    ...
    beginSearch(page1){
      if(this.state.search.string.charAt(0) != ' '){
        ...
        if(page1){
          history.pushState(null, null, window.location.origin+"/b/?i=" + '/' + 1 + (this.state.search.string ? '/' : '') + (this.state.search.string))
          //history.pushState(null, null, window.location.origin + '/b/' + 1 + (this.state.search.string ? '/' : '') + (this.state.search.string))
          this.state.curPage = 0
        } else {
          history.pushState(null, null, window.location.origin+"/b/?i=" + '/' + (this.state.curPage+1) + '/' + (this.state.search.string))
          //history.pushState(null, null, window.location.origin + '/b/' + (this.state.curPage+1) + '/' + (this.state.search.string))
        }
  ...
  mounted(){
    ...
    this.preloadImages = [
      'https://srmcgann.github.io/assets/2ftyk1.png',
      'https://srmcgann.github.io/assets/BGNlv.png',
      'https://srmcgann.github.io/assets/FU3vq.png',
      'https://srmcgann.github.io/assets/zAYeB.png',
      'https://srmcgann.github.io/assets/XeGsK.png',
      'https://srmcgann.github.io/assets/XeGsK.png',
      'https://srmcgann.github.io/assets/ct1hv.png',
      'https://srmcgann.github.io/assets/2kPCX5.png',
      'https://srmcgann.github.io/assets/14MAyj.png',
      'https://srmcgann.github.io/assets/20SIWe.png',
      'https://srmcgann.github.io/assets/6aevA.png',
      'https://srmcgann.github.io/assets/1RptlQ.png',
      'https://srmcgann.github.io/assets/v9UDT.png',
      'https://srmcgann.github.io/assets/1tgOjR.png'
    ]
